...
- Single-threaded animations (may lag on huge grids).
- No weighted edges.
- DFS/Random may loop forever on complex mazes (handled via visited).
- Tests: `src/setupTests.js` (CRA defaults).

## License

MIT (inferred from CRA template).
